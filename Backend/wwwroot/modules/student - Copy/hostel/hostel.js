    ...
    async function loadMyApplications() {
        try {
            ...
            tbody.innerHTML = apps.map(a => `
                <tr>
                    <td><strong>${a.preferredHostel?.name || a.PreferredHostel?.Name || 'Hostel'}</strong></td>
                    ...
                    <td>
                        ${a.status === 'RoomAssigned' && a.assignedRoom 
                            ? `<span class="badge badge-approved">Room #${a.assignedRoom.roomNumber}</span>` 
